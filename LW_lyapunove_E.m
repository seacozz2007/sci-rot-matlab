...
for r=rs
    ...
    iniM=zeros(1,16);
    display('get iniM');
    [t,xy]=ode45(@dJSFunZ_W_R_M_E,[0:tt/m:n*tt],iniM,options,w,-1,-1,r,2.5,-1);
    display('get data1');
    data1=xy(i1:end,5);
    iniM2 = iniM + sup_delt;
    [t,xy]=ode45(@dJSFunZ_W_R_M_E,[0:tt/m:n*tt],iniM2,options,w,-1,-1,r,2.5,-1);
    display('get data2');
    data2=xy(i1:end,5);
